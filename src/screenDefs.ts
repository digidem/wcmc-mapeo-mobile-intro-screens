...
const wcmcScreens: ScreenType[] = [
  {
    ...
    moreText: `
Mapeo was developed by Digital Democracy in close collaboration with indigenous partners in the Amazon rainforest, including Achuar, Cocama, Harakbut, Kofan, Kichwa, Matsiguenka, Siekopai, Wapichana, Waorani and Yine peoples.
...
`,
  ...
  },
  {
    ...
    moreText: `
If you are a member of an indigenous people or local community, you can choose to provide information about your conserved area (ICCA) to the UN Environment World Conservation Monitoring Centre (UNEP-WCMC). UNEP-WCMC manages information on ICCAs in order to demonstrate how important the contributions of indigenous peoples and local communities are for the conservation of our natural world.

Through the app, you can provide information on the outer boundary and location of your ICCA, alongside information on its basic characteristics. If you would also like to provide more in-depth information, photos, and links to further information, you can contact us to discuss sharing a case study through the ICCA Registry website.

Information is gathered through a series of questions that you can answer within Mapeo. No information will be sent to UNEP-WCMC until you decide to share it. The information you share will be added to a global registry of ICCAs.

If one of the main objectives of the ICCA is to conserve nature you can also choose to include your information in the World Database on Protected Areas (WDPA). This differs from the ICCA Registry because it stores information on many different conservation measures, including those managed by governments, private organisations and individuals, and indigenous peoples and local communities. This database is widely-used by people around the world to help them make decisions about how land and waters are managed.

By providing information to these databases, communities will help the international community to appreciate the vital connection between indigenous peoples, local communities and biodiversity conservation. It also helps people around the world have an awareness of  ICCAs when they make decisions.

However, communities should also consider whether they might face challenges as a result of making their information public. More information on potential benefits, and important issues to consider, is available at: www.iccaregistry.org/en/participate/benefits-and-considerations
`,
  },
  {
...

  {
    ...
    moreText: `
Before your information is made public a member of staff from UNEP WCMC will contact you with any questions. Your data will then be submitted for others to review. This is a peer-review process, and ensures that the information published in the databases is accurate. Peer-review is carried out by other indigenous peoples and/or local communities, and sometimes facilitating organisations, in the country where the ICCA is located.
